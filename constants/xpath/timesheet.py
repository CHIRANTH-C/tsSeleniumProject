...
month_drop_down_2="(//select[@class='flatpickr-monthDropdown-months'])[2]"
month_drop_down_selection="//select[@class='flatpickr-monthDropdown-months']/child::option[contains(text(),'" +selected_month+ "')]"
month_drop_down_selection_2="(//select[@class='flatpickr-monthDropdown-months']/child::option[contains(text(),'" +selected_month+ "')])[2]"
txt_input_year="//input[@class='numInput cur-year']"
txt_input_year_2="(//input[@class='numInput cur-year'])[2]"
select_date="//span[@class='flatpickr-day today' and text()='" +selected_date+ "']"
select_date_2="(//span[@class='flatpickr-day today' and text()='" +selected_date+ "'])[2]"
